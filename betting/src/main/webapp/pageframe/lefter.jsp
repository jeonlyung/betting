...
<head>
  ...
  <script src="/resources/mypage/vendor/datatables/jquery.dataTables.js"></script>
  <script src="/resources/mypage/vendor/datatables/dataTables.bootstrap4.js"></script>
  <script src="/resources/mypage/js/sb-admin.min.js"></script>
  <script src="/resources/mypage/js/demo/datatables-demo.js"></script>
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="/register">등록</a>
        </div>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/user/table">
