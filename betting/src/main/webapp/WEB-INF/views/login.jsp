    ...
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
        ...
        <form id="loginForm"  method="post" action="/login">
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="password" name = "password" id="password" class="form-control" placeholder="Password" minlength="4" data-msg-minlength="최소 {0} 자리 이상 입력해야 합니다." required="required">
          ...
          <a class="btn btn-primary btn-block" type="submit" onclick="goLogin()">로그인</a>
        </form>
